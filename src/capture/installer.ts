...
export class RecorderInstaller {
  ...
  constructor(binaryConfig?: BinaryConfig) {
    ...
    this.binaryConfig = binaryConfig || {
      ...
      version: '0.3.0',
      checksums: {
        'darwin-x64': 'd24e6d712359160d62ff52140297be71fe98c9534c9d6ac93c5b8f4daeba9408',
        'darwin-arm64': '5ed92b3ed9cc38a3f9077862886f36c95ae835d713bc7213fc3be662ecdde1c8',
        'win32-x64': '60aec6e30dabba3d5c5e0cb8b2eb959b62ef61d3f840743f7fb2726206141534',
      },
    };
