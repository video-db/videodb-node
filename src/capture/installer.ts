...
export class RecorderInstaller {
  ...
  constructor(binaryConfig?: BinaryConfig) {
    ...
    this.binaryConfig = binaryConfig || {
      ...
      version: '0.2.9',
      checksums: {
        'darwin-x64': '3716f0f6bf12fc253448f90678628a0d829cd32646928e7cd84f5e24f19796d9',
        'darwin-arm64': '50ed352dc820287d720c28da8bdba0029cd0aeeb035c84f64487ff35edfaca86',
        'win32-x64': 'dc01f195f25580edeb590b183753ceea9bab439cb36344805655a0e9a017175c',
      },
    };
